...
# GENERATE_TICKET_FROM_EIC.md (Angular local translator)

Purpose: convert an external contract (EIC) into one Angular local ticket.
...
Requirements:
- Output one Angular ticket in `tickets/active/`.
- Keep scope Angular-only.
